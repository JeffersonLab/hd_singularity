...
echo
echo 'to bind directories for use within the singularity container use the --bind/-B option with in the format src[:dest]'
...
echo 'or set environment variable SINGULARITY_BIND'
